...
class OurDriver(Driver):
    ...
    def drive(self, msg):
        ...
        try:
            ...
            self._logger.debug('sensor values caused exception: %s', err, exc_info=1)
